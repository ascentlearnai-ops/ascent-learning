...
const TabButton = ({ active, onClick, label, icon }: any) => (
  <button
    onClick={onClick}
    className={`px-6 py-2.5 rounded-full font-bold text-xs uppercase tracking-wide flex items-center gap-2 transition-all duration-300 ${
      active 
                        ...
                        <div className="h-full flex flex-col">
                            {qLoading ? (
                                ...
                                <div className="text-center h-full flex flex-col items-center justify-center space-y-8">
                                    ...
                                    <div>
                                      <h2 className="text-4xl font-bold text-white mb-2">Module Complete</h2>
